import { MapPin, Mail, Phone, Leaf, Award, Users } from "lucide-react";
  ...
  return (
    <footer id="contact" className="bg-gray-900 text-white py-12" role="contentinfo" aria-label="Site footer">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Farm to Flame banner */}
        <div className="bg-green-500/20 border border-green-500/40 rounded-lg p-6 mb-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <Award className="h-8 w-8 text-green-500" aria-hidden="true" />
              <div>
                <h3 className="font-storybook text-xl text-parchment font-semibold">Farm to Flame</h3>
                <p className="font-garden text-sm text-gray-300">Local craft cannabis with farmer knowledge</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              <Users className="h-8 w-8 text-green-500" aria-hidden="true" />
              <div>
                <h3 className="font-storybook text-xl text-parchment font-semibold">Community Committed</h3>
                <p className="font-garden text-sm text-gray-300">Events, education, and local connection</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              <Leaf className="text-green-500 mr-3 h-8 w-8" aria-hidden="true" />
            ...
            <p className="font-garden text-gray-400 mb-4 max-w-md">
              {settings.siteTagline || "NYS licensed microbusiness dispensary focused on Farm to Flame craft cannabis from Central and Western NY."}
            </p>
