...
const defaultSettings: HomepageSettings = {
  ...
  heroTagline: "Premium Craft Cannabis",
  heroSubtitle: "Veteran-owned. Buffalo-grown. Crafted with precision and care for those who appreciate quality.",
  heroShopButtonText: "Shop Our Collection",
  heroStoryButtonText: "Our Story",
  heroVeteranBadge: "Veteran-Owned & Operated",
  ...
  trustBadge2Title: "Veteran Excellence",
  trustBadge2Desc: "Military precision in cultivation",
  ...
  socialProofQuote: "From service to soil — bringing veteran values to cannabis cultivation",

  // Featured Products Section
  featuredTitle: "Discover Our Harvest",
  featuredSubtitle: "Carefully cultivated in Buffalo's unique micro-terroir for exceptional quality and flavor",
  featuredBadgeText: "Featured Collection",
  featuredCtaText: "View Full Collection",
  featuredShippingNote: "Free local delivery on orders over $100",
  placeholder1Name: "Premium Flower",
  placeholder1Desc: "Hand-selected craft cannabis",
  placeholder2Name: "Artisan Pre-Rolls",
  placeholder2Desc: "Expertly rolled for convenience",
  placeholder3Name: "Seasonal Harvest",
  placeholder3Desc: "Limited batch releases",

  // Brand Story Section
  storyTitle: "From Service to Soil",
  storyText: "Garden of Weeden was founded by veterans who believe in bringing the same dedication, discipline, and attention to detail from military service to cannabis cultivation. Our Buffalo roots run deep, and we're committed to growing premium craft cannabis that honors both our service and our community.",
  storyButton1Text: "Read Our Full Story",
  storyButton2Text: "Explore Products",

  // Urgency Banner
  urgencyBadge: "Limited Availability",
  urgencyTitle: "Fresh Batch Now Available",
  urgencyDesc: "Small-batch, sun-grown craft cannabis — while supplies last",
  urgencyCtaText: "Shop Now",

  // Benefits Section
  benefitsTitle: "Why Choose Garden of Weeden?",
  benefitsSubtitle: "Experience the difference that veteran values and Buffalo's unique terroir make",
  benefit1Title: "Veteran-Crafted Quality",
  benefit1Desc: "Military precision in every harvest",
  benefit2Title: "Sun-Grown Excellence",
  benefit2Desc: "Natural outdoor cultivation",
  benefit3Title: "Lab-Tested & Safe",
  benefit3Desc: "Rigorous quality assurance",
  benefit4Title: "Small-Batch Freshness",
  benefit4Desc: "Limited harvests, maximum care",
  benefit5Title: "Wellness-Focused",
  benefit5Desc: "Supporting healing journeys",
  benefit6Title: "Buffalo Local",
  benefit6Desc: "Community-rooted cultivation",
  benefitsCtaText: "Shop Premium Cannabis",

  // Newsletter Section
  newsletterTitle: "Join the Garden Guild",
  newsletterSubtitle: "Get exclusive access to new harvests, member-only discounts, and Buffalo cannabis culture.",
  newsletterBenefit1: "Early access to limited batches",
  newsletterBenefit2: "Member-only discounts",
  newsletterBenefit3: "Buffalo cannabis community updates",
  newsletterCtaText: "Join Now — It's Free",
